...
export const period = {
  label: '2026년 2분기',
  basisNote: '환경부 배출 계수 · 한국교통연구원 사회적 비용 산식 기준 · 8월 12일 기준',
};
...
export const corpStats: StatData[] = [
  { label: '온실가스 감축', value: '182 tCO₂eq', delta: '도로 단독 대비 74% 감소', deltaTone: 'up' },
  { label: '운송비 절감', value: '4,500만 원', delta: '합적 단가 18% 인하', deltaTone: 'up' },
  { label: '사회환경적 편익', value: '11억 4,000만 원', delta: '4대 편익 합산', deltaTone: 'flat' },
  { label: '철도 전환율', value: '46.2%', delta: '전 분기 31.5%', deltaTone: 'up' },
];

export const korailStats: StatData[] = [
  { label: '공차율', value: '18.7%', delta: '전 분기 31.2%', deltaTone: 'up' },
  { label: '채운 화차', value: '128량', delta: '이번 분기 신규 배정', deltaTone: 'flat' },
  { label: '추가 운송 수익', value: '8,700만 원', delta: '공차 노선 재판매분', deltaTone: 'up' },
...
export const korailRows: MatchRowData[] = [
  {
    ...
    route: '울산 → 의왕ICD',
    wagon: 'KRC-1204',
    sub: '컨테이너 화차 12량 · 대성물산 단독, 화주 3곳 조율 중',
    tons: '1,860t',
    load: 41,
    saving: '산정 전',
    tone: 'nego',
