...
export const applyMeta = {
  ...
  legalBasis: '지속가능 교통물류 발전법 제21조 · 국토교통부 고시 제2019-16호 서식에 맞춰 작성됩니다.',
...
export const generateSteps: GenerateStep[] = [
  ...
  { label: '사회환경적 편익 산출', result: '절감비용 11억 4,000만 원', done: true },
  { label: '보조금 산정식 적용', result: '상한액 3억 4,200만 원', done: true },
  { label: '서술 문단 작성 중', result: '6개 문단 중 4번째', done: false, ai: true },
];
...
export const docHeader = {
  ...
  sign: '2026년 8월 12일 · 신청인 대성물산 주식회사 대표이사 이대성 (인)',
};

export const applicant: { label: string; value: string; wide?: boolean }[] = [
  { label: '상호', value: '대성물산 주식회사' },
  { label: '사업자등록번호', value: '220-81-04512' },
  { label: '대표자', value: '이대성' },
  { label: '담당자', value: '김철도 · 02-6000-1234' },
  { label: '소재지', value: '울산광역시 남구 여천로 217', wide: true },
];
...
export const planRows: PlanRow[] = [
  { section: '울산 → 의왕ICD', item: '석유화학제품', tons: '1,860톤', trips: '5회', wagonType: '컨테이너' },
  { section: '광양 → 오봉', item: '화학원료', tons: '1,540톤', trips: '4회', wagonType: '유개화차' },
  { section: '포항 → 부곡', item: '철강재', tons: '880톤', trips: '3회', wagonType: '무개화차' },
];
...
export const costRows: CostRow[] = [
  { label: '철도수송비', formula: '4,280t × 96,500원', amount: '413,020,000원' },
  { label: '상하역비', formula: '12회 × 4,850,000원', amount: '58,200,000원' },
  { label: '셔틀운송비', formula: '양단 42km × 12회', amount: '36,780,000원' },
  { label: '도로수송비 (차감)', formula: '기존 도로 운송 실적 기준', amount: '△93,000,000원' },
];
...
export const benefitDocRows: BenefitDocRow[] = [
  { label: '온실가스 감축', basis: '182 tCO₂eq', source: '환경부 배출계수', amount: '158,000,000원' },
  { label: '대기오염 저감', basis: 'NOx·SOx·PM2.5', source: '환경부 사회적비용 단가', amount: '64,000,000원' },
  { label: '교통사고 예방', basis: '대형화물차 45대 감소', source: 'KOTI 산식', amount: '53,000,000원' },
  { label: '도로혼잡 완화', basis: '차량·km 감소분', source: 'KOTI 산식', amount: '865,000,000원' },
];

export const benefitDocTotal = '1,140,000,000원';

export const subsidyRows = [
  { label: '추가비용 (A)', formula: '3. 추가비용 산출 합계', amount: '415,000,000원' },
...
export const paragraphs: Record<'plan' | 'benefit' | 'closing' | 'esg', AiParagraph> = {
  plan: {
    id: 'p1',
...
export const esgHeader = {
  ...
  org: '대성물산 주식회사 · 물류 부문 Scope 3',
  guideline: '공급망 실사 대응 K-ESG 가이드라인 (산업통상자원부 · 한국생산성본부) 기준으로 작성되었습니다.',
};
